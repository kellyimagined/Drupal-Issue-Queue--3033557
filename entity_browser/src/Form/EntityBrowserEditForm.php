...
class EntityBrowserEditForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    if ($entity_browser->isNew()) {
      ...
      $help_text .= '<p>' . $this->t('You can find more detailed information about creating and configuring Entity Browsers at the <a href="@guide_href" target="_blank">official documentation</a>.', ['@guide_href' => 'https://www.drupal.org/docs/8/modules/entity-browser/entity-browser']) . '</p>';
      $help_text .= '</div>';
      $form['help_text'] = [
        '#markup' => $help_text,
      ];
